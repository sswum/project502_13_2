...
import org.choongang.global.member.controllers.JoinController;
import org.choongang.global.member.controllers.LoginController;
...
public class MainRouter implements Router {
    ...
    public void change(Menu menu) {
        ...
        switch(menu) {
            case JOIN : controller = new JoinController();
